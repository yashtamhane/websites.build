export default function Footer() {
  return (
    <footer id="contact" className="bg-primary text-background py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
          ...
          <div>
            <div className="flex flex-col mb-4">
              <div className="flex items-baseline">
                <span className="text-2xl font-bold text-background">websites</span>
            ...
            <p className="text-background/80 text-sm">
              Professional websites for small businesses, restaurants, and personal portfolios.
            </p>
          </div>
        ...
        <div className="border-t border-background/20 pt-8 text-center text-background/70 text-sm">
          <p>&copy; {new Date().getFullYear()} websites.build. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
