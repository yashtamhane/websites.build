    ...
    <section id="contact" className="py-20 px-6 bg-white">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600">Have questions or need help choosing? We're here for you!</p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div className="bg-gradient-to-br from-pink-50 to-purple-50 rounded-3xl p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <button
                type="submit"
                className="w-full bg-pink-600 text-white py-4 rounded-xl hover:bg-pink-700 transition-colors font-semibold text-lg"
              >
                Send Message
              </button>
            </form>
          ...
          <div className="space-y-8">
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">123 Gift Street, Shopping Plaza<br />Mumbai, Maharashtra 400001</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">+91 99999 99999<br />Mon-Sat: 10 AM - 8 PM</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">info@giftgallery.com<br />support@giftgallery.com</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="flex gap-4">
                <a href="#" className="w-12 h-12 bg-pink-100 rounded-full flex items-center justify-center hover:bg-pink-600 hover:text-white transition-colors">
