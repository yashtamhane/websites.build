export default function DevFooter() {
  return (
    <footer className="bg-slate-800 border-t border-emerald-400/20 py-8 px-12">
      <div className="max-w-6xl mx-auto">
          ...
          <div className="flex gap-4">
            {[
              ...
              <a
                key={social.name}
                href="#"
                className="w-10 h-10 bg-slate-700 border border-emerald-400/20 rounded-lg flex items-center justify-center hover:border-emerald-400/50 hover:bg-emerald-400/10 transition-all group"
        ...
        <div className="mt-8 pt-8 border-t border-emerald-400/20 text-center">
          <p className="text-gray-400 font-mono text-sm">
            Built with <span className="text-red-500">♥</span> by DevName
            <span className="text-emerald-400 mx-2">|</span>
            <span className="text-cyan-400">{new Date().getFullYear()}</span>
          </p>
